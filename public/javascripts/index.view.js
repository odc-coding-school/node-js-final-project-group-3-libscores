...
var league_one_header = `
    <section class="">
        ...
        <img src="/images/league_1.png" alt="" class="sm-logo margin-left round">
                    ...
                    $(`
                       <section class="box row padding margin-top padding-right">
                        ...
                        <section class="column max">
                            <span class="row">
                                <img src="${item.teams.home.logo ? item.teams.away.logo : '/images/shield.webp' }" alt="" class="sm-logo">
                                <h3 class="bold max">${item.teams.home.name}</h3>
                                <h3 class="${item.status == 3 ? 'black' : 'red'}">${item.score.summary.score1}</h3>
                            </span>
                            <span class="row">
                                <img src="${item.teams.away.logo ? item.teams.away.logo : '/images/shield.webp' }" alt="" class="sm-logo">
