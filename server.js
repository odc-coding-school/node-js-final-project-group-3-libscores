...
db.serialize(function createDB() {
  ...
  db.run("CREATE TABLE IF NOT EXISTS players (id INTEGER PRIMARY KEY AUTOINCREMENT, fullname VARCHAR(50) NOT NULL, DOB DATE NOT NULL, position CHAR(10) NOT NULL, clubs VARCHAR(50) NOT NULL, country VARCHAR(20) NOT NULL, club_id INTEGER NULL)");

  db.run("CREATE TABLE IF NOT EXISTS competitions (id INTEGER PRIMARY KEY AUTOINCREMENT,  competition VARCHAR(50) NOT NULL, country_id INTEGER NOT NULL,clubs INTEGER NOT NULL, logo VARCHAR(50) NULL,founded VARCHAR(50) NOT NULL, type VARCHAR(50) NOT NULL, players INTEGER NOT NULL)");

  db.run("CREATE TABLE IF NOT EXISTS clubs (id INTEGER PRIMARY KEY AUTOINCREMENT, club VARCHAR(50) NOT NULL, founded VARCHAR(50) NULL, country_id INTEGER NOT NULL, squad INTEGER NULL, stadium VARCHAR(50) NULL, market_value INTEGER NULL, badge BLOB NULL )");

  db.run("CREATE TABLE IF NOT EXISTS games (id INTEGER PRIMARY KEY AUTOINCREMENT, home INTEGER NOT NULL, away INTEGER NOT NULL, start DATE NOT NULL, status INTEGER NOT NULL, date DATE NOT NULL, home_goal INTEGER NOT NULL, away_goal INTEGER NOT NULL, season_id INTEGER NOT NULL, score VARCHAR(10) NOT NULL)");
