...
db.serialize(() => {
  db.run('CREATE TABLE IF NOT EXISTS Leagues( ID INTEGER  PRIMARY KEY AUTOINCREMENT, Name VARCHAR(50) NOT NULL, logo VARCHAR(50) NOT NULL)');
    ...
    db.run('CREATE TABLE IF NOT EXISTS players( first_name VARCHAR(50)  NOT NULL, middle_name VARCHAR(50)NULL, last_name VARCHAR(50) NOT NULL, DOB DATE NOT NULL, team_id INTEGER NOT NULL, player_id INTEGER NOT NULL)');
});
